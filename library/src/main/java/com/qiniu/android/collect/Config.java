...
public class Config {
     ...
     * 上传信息收集文件的地址
     */
    public final static String serverURL = "https://proxy-uplog-qbox-me.qnssl.com/log";

    public final static String serverURL2 = "https://proxy-uplog-qbox-me.qnssl.com/log/2";
